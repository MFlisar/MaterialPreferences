...
inline fun Screen.Appendable.switch(setting: StorageSetting<Boolean>, block: com.michaelflisar.materialpreferences.preferencescreen.bool.switchb.SwitchPreference.() -> Unit) =
        com.michaelflisar.materialpreferences.preferencescreen.bool.switchb.SwitchPreference(setting)
